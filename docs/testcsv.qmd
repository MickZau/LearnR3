...
# CGM files
cgm_data <- here("L:/LovbeskyttetMapper/AID projekt - Collab grant/WP2+3 (AIDBeyond)/AID-BEYOND TMF/12) Uploads and raw data/Voksen/Project Dexcom G7/Control/Follow-up/CSV/") |>
  fs::dir_ls(glob = "*.csv") |>
  map(readr::read_csv,
      show_col_types = FALSE) |> 
 # map(mutate,
     # Glucose = as.integer("Glucose Value (mmol/L)",
                          # )) |> 
  map(rename,
